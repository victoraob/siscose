                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                <a href="<?php echo constant('URL'); ?>admin/editproduct/<?php echo $producto["id_products"]; ?>" class="btn btn-warning">
                                                    <i class="fas fa-edit "></i>
                                                </a>

                                                <!-- <button type="button" class="btn btn-info" data-toggle="modal" data-target="#adddesc<?php echo $producto["id_products"]; ?>"><i class="fas fa-percentage"></i></button> -->
