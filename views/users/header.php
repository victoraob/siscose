         ...
         <nav id="sidebar">
            ...
            <div class="sidebar_blog_2">
               ...
               <ul class="list-unstyled components">
                  ...
                  <li><a href="<?php echo constant('URL') ?>user"><i class="fa fa-home blue_color"></i> <span> &nbsp;Inicio</span></a></li>

                  <li><a href="<?php echo constant('URL') ?>user/equipos"><i class="fa fa-desktop"></i> <span> &nbsp;Equipos</span></a></li>

                  <li><a href="<?php echo constant('URL') ?>user/solicitudes"><i class="fa fa-spinner"></i> <span> &nbsp;Solicitudes</span></a></li>

                  <li><a href="<?php echo constant('URL') ?>user/mantenimiento"><i class="fa fa-wrench"></i> <span> &nbsp;Mantenimiento</span></a></li>
                  ...
                  <div class="full">
                     ...
                     <div class="right_topbar">
                        <div class="icon_info">
                           ...
                           <ul>
                                 <!-- <li><a href="<?php echo constant('URL') ?>user/notifications"><i class="fa fa-bell"></i><span class="badge">2</span></a></li> -->
                           ...
                           <ul class="user_profile_dd">
                              <li>
                                 <a class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <?php echo ucfirst($_SESSION['usuario'][0]['name'])?></span></a>
